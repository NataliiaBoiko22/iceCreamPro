...
var _galery = require("./js/galery");
var _customerReviews = require("./js/customer-reviews");
var _modal = require("./js/modal");
var _slidingMenu = require("./js/sliding-menu");

},{"./js/galery":"kBdKN","./js/customer-reviews":"andh0","./js/modal":"aHHgN","./js/sliding-menu":"azRKd"}],"kBdKN":[function(require,module,exports) {
...
function changeGallerySlide(num) {
    for(let i = 0; i < gallerySlides.length; i++)gallerySlides[i].classList.remove("active");
    gallerySlides[num].classList.add("active");
}

},{}],"andh0":[function(require,module,exports) {
...
for (let nav of navs)nav.onclick = ()=>{
...
(()=>{
    ...
    for (let openBtn of refs.openModalBtn){
        ...
        function openSomeModal(num) {
            for(let i = 0; i < refs.modal.length; i++)refs.modal[i].classList.add("is-hidden");
...
},{}],"azRKd":[function(require,module,exports) {
(()=>{
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequireab38")
